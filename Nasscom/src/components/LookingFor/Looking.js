...
import styles from './LookingStyle';
        ...
        return (
            <SafeAreaView style={{ flex: 1 }}>
                <View style={{ justifyContent: 'center', alignItems: 'center', paddingTop: 10, }}>
                    <Text style={{ fontSize: 15 }}>I am Looking for</Text>
                </View>
                <View style={{ paddingTop: 15, flex: 8 }}>
                    <SectionList
                        sections={this.props.store.values}
                        renderSectionHeader={({ section }) => <View style={styles.SectionHeaderStyle}>
